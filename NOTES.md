...
```
Game Code:  67 of 777 files complete  105,880 / 2,116,616 bytes  1,196 / 10,697 fn
            5.0023% of game code

Of those 1,196 functions, 778 are GENERATED -- machine-recognised
shapes, not one of which is decompiling. They are real matched
functions and the offsets and constants are recovered fact, but a
count of them is not a count of decompiled code. HAND-WRITTEN IS
418, across 107 units and 96,984 bytes, and that is the figure to
