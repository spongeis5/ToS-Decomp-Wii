...
```
Game Code:  67 of 777 files complete  170,940 / 2,116,616 bytes  1,715 / 10,697 fn
            8.0761% of game code

Of those 1,715 functions, 759 are GENERATED -- machine-recognised
shapes, not one of which is decompiling. They are real matched
functions and the offsets and constants are recovered fact, but a
count of them is not a count of decompiled code. HAND-WRITTEN IS
956, across 203 units and 162,288 bytes, and that is the figure to
compare against earlier ones.

Data:       4 unit(s) carry their own, 412 bytes; 134 more could
All:        4.31% matched              main.dol reproduces byte for byte
```
