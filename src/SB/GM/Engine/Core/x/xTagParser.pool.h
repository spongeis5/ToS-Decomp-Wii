...
//
// xTagParser.cpp is a fragment of a unity translation unit and builds no
// string pool of its own, but the files in front of it put .rodata
// ahead of its float literals: in the image the unit's first
// literal (0x8067D440) lies 24 bytes past the lowest .rodata address
// the translation unit forms (0x8067D428). mwcc shares one base among
