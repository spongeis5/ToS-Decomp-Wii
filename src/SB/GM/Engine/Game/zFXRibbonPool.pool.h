...
//
// zFXRibbonPool.cpp is a fragment of a unity translation unit and builds no
// string pool of its own, but the files in front of it put .rodata
// ahead of its float literals: in the image the unit's first
// literal (0x8068BA50) lies 50912 bytes past the lowest .rodata address
...
static const unsigned char kUnityRodataAhead[50912] = {1};
