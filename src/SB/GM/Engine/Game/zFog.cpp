// zFog's Create was emitted by tools/transplant.py; the Init below
...
void FloatingCollectibleEventWrapper(xBase* from, xBase* to, unsigned int event,
                                     Sext::EventAny* any);
...
void zFog::Init(Sext::zFogAsset* asset) {
    xBaseInit((xBase*)this, (const Sext::xBaseAsset*)asset);
    this->asset = asset;
    eventFunc = FloatingCollectibleEventWrapper;
    linkArray = (LinkAsset*)((char*)asset + 44);
}
