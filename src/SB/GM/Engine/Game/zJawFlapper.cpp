...
namespace zJawFlapperNS {
enum JawBoneMovementType { JawBoneMovementType_ = 0x7FFFFFFF };
}  // namespace zJawFlapperNS


class zJawFlapper {
public:
    void SetJawCyclePeriod(float value);
    void SetJawSpeechType(zJawFlapperNS::JawBoneMovementType value);
...
void zJawFlapper::SetJawCyclePeriod(float value) { f20 = value; }
void zJawFlapper::SetJawSpeechType(zJawFlapperNS::JawBoneMovementType value) { f48 = (int)value; }
