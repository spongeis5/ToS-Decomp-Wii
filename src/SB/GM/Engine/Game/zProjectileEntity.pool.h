...
//
// zProjectileEntity.cpp is a fragment of a unity translation unit and builds no
// string pool of its own, but the files in front of it put .rodata
// ahead of its float literals: in the image the unit's first
// literal (0x8068D2D0) lies 65032 bytes past the lowest .rodata address
// the translation unit forms (0x8067D4C8). mwcc shares one base among
...
static const unsigned char kUnityRodataAhead[65032] = {1};
