...
//
// zTrampoline, transplanted from Sext::zEventSpyAsset::Create, which
...
// virtuals is defined, which is what leaves __vt__zTrampoline
...
namespace Sext { class zTrampolineAsset; }

class zEnt {
public:
    zEnt(World::EntityHandleBase* handle);
};

class zTrampoline : public zEnt {
public:
    zTrampoline(World::EntityHandleBase* handle) : zEnt(handle) {}
    ...
    virtual void Init(Sext::zTrampolineAsset* asset);

    unsigned char _pad0[0xE0 - 0x4];
};

namespace Sext {

class zTrampolineAsset {
public:
    static ::zTrampoline* Create(World::EntityHandleBase* handle,
                                 zTrampolineAsset* asset);
};

}  // namespace Sext

zTrampoline* Sext::zTrampolineAsset::Create(World::EntityHandleBase* handle,
                                            zTrampolineAsset* asset) {
    ::zTrampoline* entity = new (memset(
        Memory::AllocGlobalHeap(sizeof(::zTrampoline), (Memory::GlobalHeapEnum)0,
                                (eMemMgrTag)16, false),
        0, sizeof(::zTrampoline))) ::zTrampoline(handle);
