...
//
// WAD04_14.cpp is a fragment of a unity translation unit and builds no
// string pool of its own, but the files in front of it put .rodata
// ahead of its float literals: in the image the unit's first
// literal (0x80691560) lies 74508 bytes past the lowest .rodata address
// the translation unit forms (0x8067F254). mwcc shares one base among
