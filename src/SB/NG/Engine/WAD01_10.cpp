...
namespace Graphics { class RenderSceneCollider; }

namespace Graphics {

class Scene {
public:
    void SetRenderSceneCollider(Graphics::RenderSceneCollider* value);
...
void Graphics::Scene::SetRenderSceneCollider(Graphics::RenderSceneCollider* value) { f40 = (int)value; }
