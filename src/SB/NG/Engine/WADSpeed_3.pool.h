...
//
// WADSpeed_3.cpp is a fragment of a unity translation unit and builds no
// string pool of its own, but the files in front of it put .rodata
// ahead of its float literals: in the image the unit's first
// literal (0x80695AD0) lies 0 bytes past the lowest .rodata address
// the translation unit forms (0x80695AD0), or no pool's referrers span the unit and only the floor is known. mwcc shares one base among
