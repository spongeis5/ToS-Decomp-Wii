...
namespace TRC { class GameInterface; }

namespace TRC {

class TRCModule {
public:
    void RegisterGameInterface(TRC::GameInterface* value);

    unsigned char _pad0[0x288];
    int f288;
};

}  // namespace TRC

void TRC::TRCModule::RegisterGameInterface(TRC::GameInterface* value) { f288 = (int)value; }
