...
EXPECT = {
    ...
    "SB/GM/Engine/Game/zSound": (27, 28),
    ...
    "SB/GM/Engine/Game/zNPCFX": (24, 24),
    ...
    "SB/GM/Engine/Game/zNPCGenericSwarm": (25, 29),
    "SB/GM/Engine/Game/zNPCManager": (18, 27),
    "SB/GM/Engine/Game/zPOWGroup": (15, 18),
    "SB/GM/Engine/Game/zPhysicsObject": (3, 3),
    "SB/GM/Engine/Game/zPlanktonPlayer": (57, 59),
    ...
    "SB/GM/Engine/Game/zSBPlayerActions": (467, 481),
    ...
    "SB/GM/Engine/Game/zPlayerTemplate": (3, 3),
    ...
    "SB/NG/Source/Engine/Entities/GeometryEntity": (5, 6),
    ...
    "SB/NG/Source/Engine/Graphics/MaterialDepot": (9, 9),
    "SB/GM/Engine/Game/zDestructibles": (3, 6),
    "SB/GM/Engine/Game/zHintSphere": (7, 8),
    "SB/GM/Engine/Game/zHudSB": (18, 19),
